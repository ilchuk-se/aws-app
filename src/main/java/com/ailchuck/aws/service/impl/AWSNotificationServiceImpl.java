...
import com.ailchuck.aws.configuration.SNSClientProperties;
import com.ailchuck.aws.configuration.SQSClientProperties;
import com.ailchuck.aws.controller.AWSImageController;
...
public class AWSNotificationServiceImpl implements AWSNotificationService {
    ...
    public void sendMessageToSQS(ImageInfoDTO imageInfoDTO) {
        var downloadLink = WebMvcLinkBuilder.linkTo(methodOn(AWSImageController.class).getImage(imageInfoDTO.getName()));
